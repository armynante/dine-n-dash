<aside class="bg-white lg:fixed lg:bottom-0 lg:right-0 lg:top-16 lg:w-96 lg:overflow-y-auto lg:border-l lg:border-slate-400/2">
  <header class="flex items-center justify-between border-b border-slate-400/2 px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
    <h2 class="text-base font-semibold leading-7 text-slate-400">Activity feed</h2>
  ...
  <ul role="list" class="divide-y divide-white/5">
    <li class="px-4 py-4 sm:px-6 lg:px-8">
      <div class="flex items-center gap-x-3">
        ...
        <h3 class="flex-auto truncate text-sm font-semibold leading-6 text-amber-400">Michael Foster</h3>
