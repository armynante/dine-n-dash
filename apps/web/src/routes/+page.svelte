...
<div class="flex items-center rounded-full mt-6">
  <img src="/running_man.jpg" class="w-96" alt=""/>
</div>
...
<p class="mt-4 text-lg text-gray-500">
  Keep an eye out for hard to get reservations at your favorite restaurants.
  <br> Use as a CLI or a web app.
</p>
